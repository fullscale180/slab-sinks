...
namespace FullScale180.SemanticLogging
{
    internal static class Guard
    {
        ...
        public static void ArgumentNotNullOrEmpty(string argumentValue, string argumentName)
        {
            ...
            {
                throw new ArgumentException(Properties.Resource.ArgumentIsEmptyError, argumentName);
            }
        }
        ...
        public static void ArgumentGreaterOrEqualThan<T>(T lowerValue, T argumentValue, string argumentName) where T : struct, IComparable
        {
            ...
            {
                throw new ArgumentOutOfRangeException(argumentName, argumentValue, string.Format(CultureInfo.CurrentCulture, Properties.Resource.ArgumentNotGreaterOrEqualTo, argumentName, lowerValue));
            }
        }
        ...
        public static void ArgumentLowerOrEqualThan<T>(T higherValue, T argumentValue, string argumentName) where T : struct, IComparable
        {
            ...
            {
                throw new ArgumentOutOfRangeException(argumentName, argumentValue, string.Format(CultureInfo.CurrentCulture, Properties.Resource.ArgumentNotLowerOrEqualTo, argumentName, higherValue));
            }
        }
        ...
        public static void ArgumentIsValidTimeout(TimeSpan? argumentValue, string argumentName)
        {
            if (argumentValue.HasValue)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(string.Format(CultureInfo.CurrentCulture, Properties.Resource.TimeSpanOutOfRangeError, argumentName));
                }
            }
        }
        ...
        public static void ValidDateTimeFormat(string format, string argumentName)
        {
            ...
            {
                throw new ArgumentException(argumentName, Properties.Resource.InvalidDateTimeFormatError, e);
            }
        }
    }
}
